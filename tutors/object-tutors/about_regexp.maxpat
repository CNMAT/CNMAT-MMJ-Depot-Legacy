...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "Object Tutors : about regexp", "Explain the functionalities of the regexp object", "0.296 0.594 0.784 0.5" ],
					"id" : "obj-46",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 11.0, 5.0, 502.0, 74.0 ],
...
,
					"patching_rect" : [ 347.0, 202.0, 124.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 178.0, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 18.0, 203.0, 123.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 241.0, 178.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 148.0, 178.0, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 241.0, 203.0, 103.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 148.0, 203.0, 87.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 151.0, 505.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 85.0, 188.0, 23.0 ],
					"text" : "regexp is fun!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 110.0, 568.0, 34.0 ],
					"text" : "regular expressions (or regexps, regexes) are an extremely powerful tool for manipulating text and data. \nthis tutorial made by members of the cycling74 forums aims to help explain the use of regexp in maxmsp."
				}

			}
, 			{
				"box" : 				{
					"args" : [ "about_regexp", 0.5, "Rafael Valle", "about_regexp", 6666, "0.296 0.594 0.784 0.5" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 319.0, 319.0, 292.0, 86.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 269.0, 237.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.124298, 250.0, 70.87571, 16.0 ],
					"text" : "pas d'accent"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 373.66394, 108.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 344.770477, 67.604523, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 250.0, 113.401131, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 52.0, 290.450806, 146.112991, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 156.834747, 326.278687, 61.5, 326.278687 ],
					"source" : [ "obj-7", 3 ]
				}
