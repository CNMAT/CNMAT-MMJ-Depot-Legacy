...
, 			{
				"box" : 				{
					"args" : [ "shelf_filter", "1.2a", "Valle and Zbyszynski", "shelf_filter", 6666, "0.296 0.594 0.784 0.5" ],
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 632.0, 292.0, 86.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "peqbank~ overview", "the shelf filter", "0.296 0.594 0.784 0.5" ],
					"id" : "obj-2",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
