...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "on_waveforms", 1.0, "authors", "on_waveforms", 6666, "0.296 0.594 0.784 0.5" ],
					"id" : "obj-15",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 506.0, 10.0, 296.0, 86.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "Topic Tutors : on waveforms", "Explains waveforms in detail", "0.296 0.594 0.784 0.5" ],
					"id" : "obj-46",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 6.0, 10.0, 502.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 193.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.0, 345.0, 100.0, 20.0 ],
					"text" : "partial number",
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 646.0, 346.0, 100.0, 20.0 ],
					"text" : "triangle",
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 346.0, 100.0, 20.0 ],
					"text" : "sawtooth",
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 117.0, 197.0, 225.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.0, 117.0, 198.0, 227.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.0, 117.0, 199.0, 223.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.0, 346.0, 100.0, 20.0 ],
					"text" : "square",
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ]
				}
