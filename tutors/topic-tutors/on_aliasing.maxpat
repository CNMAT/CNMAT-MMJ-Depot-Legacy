...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "Topic Tutors : on aliasing", "Explains aliasing in detail", "0.296 0.594 0.784 0.5" ],
					"id" : "obj-46",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 11.5, 4.0, 502.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -5.0, -23.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 66.0, 437.0, 133.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 399.0, 423.0, 292.0, 14.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 399.0, 406.0, 282.0, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "bang", "bang", "", "int" ],
					"patching_rect" : [ 399.0, 391.0, 196.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 732.0, 413.0, 388.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 731.0, 381.0, 379.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 732.0, 330.0, 281.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 423.0, 291.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 451.0, 399.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 407.0, 282.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 312.0, 396.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 236.0, 397.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 132.0, 404.0, 103.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 393.0, 184.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 100.0, 155.0, 27.0 ],
...
,
					"patching_rect" : [ 310.0, 512.0, 143.0, 34.0 ],
...
,
					"patching_rect" : [ 147.0, 512.0, 143.0, 34.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.0, 206.0, 69.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 293.0, 100.0, 39.0 ],
					"text" : "What you <- get"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.0, 206.0, 63.0, 20.0 ],
					"text" : "pack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 148.0, 122.0, 60.0, 20.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 35.0, 88.0, 26.0, 26.0 ]
				}
...
,
					"patching_rect" : [ 199.0, 184.0, 56.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 51.0, 179.0, 64.0, 20.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 155.0, 230.0, 76.0, 190.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 508.0, 37.0, 20.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.0, 370.0, 22.0, 122.0 ],
					"stripecolor" : [ 0.66667, 0.66667, 0.66667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 35.0, 342.0, 72.0, 20.0 ],
					"text" : "cycle~ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 122.0, 107.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 35.0, 151.0, 36.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					"args" : [ "aliasing", 1.2, "Valle, Zbyszynski and Wright", "aliasing", 4153, "0.296 0.594 0.784 0.5" ],
					"id" : "obj-36",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 517.0, 310.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 94.0, 54.0, 20.0 ],
					"text" : "click me"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 293.0, 100.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 361.0, 77.0, 20.0 ],
					"text" : "More online:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 88.0, 406.0, 412.0 ],
					"rounded" : 20,
					"shadow" : -3
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 157.5, 148.0, 44.5, 148.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 105.5, 200.0, 164.5, 200.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 105.5, 200.0, 125.0, 200.0, 125.0, 200.0, 164.0, 200.0, 164.0, 176.0, 208.5, 176.0 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.0, 502.0, 62.5, 502.0 ],
					"source" : [ "obj-32", 0 ]
				}
