...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "on_initialization", 1.0, "authors", "on_initialization", 6666, "0.296 0.594 0.784 0.5" ],
					"id" : "obj-64",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 505.5, 8.0, 296.0, 86.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "Topic Tutors : on initialization", "Explains initialization in detail", "0.296 0.594 0.784 0.5" ],
					"id" : "obj-63",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 7.0, 10.0, 502.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 764.0, 568.0, 217.0, 27.0 ],
...
,
					"patching_rect" : [ 34.0, 361.0, 294.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.0, 167.0, 49.0, 17.0 ],
					"text" : "r keyinit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 453.0, 163.0, 27.0 ],
					"text" : "space bar = start"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 396.0, 139.0, 27.0 ],
					"text" : "i = initialization"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 424.0, 165.0, 27.0 ],
					"text" : "return key = stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 44.0, 756.0, 66.0, 17.0 ],
					"text" : "cycle~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 773.0, 90.0, 17.0 ],
					"sig" : 0.0
				}
...
,
					"patching_rect" : [ 234.0, 149.0, 81.0, 17.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 594.0, 163.0, 89.0, 17.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 690.0, 321.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 117.0, 717.0, 100.0, 17.0 ],
					"text" : "= audio on"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 96.0, 716.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 97.0, 737.0, 81.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 216.0, 256.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 354.0, 256.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 253.0, 120.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, 223.0, 33.0, 17.0 ],
					"text" : "s init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 266.0, 186.0, 32.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 172.0, 59.0, 79.0 ],
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 718.0, 33.0, 33.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 329.0, 395.0, 366.0, 71.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.0, 43.0, 387.0, 98.0 ],
...
,
					"patching_rect" : [ 50.5, 626.0, 253.0, 27.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 733.0, 231.0, 361.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 688.0, 508.0, 347.0, 48.0 ],
...
,
					"patching_rect" : [ 686.0, 608.0, 262.0, 29.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 733.0, 287.0, 369.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 733.0, 201.0, 369.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.5, 508.0, 370.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.5, 570.0, 353.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 985.0, 840.0, 33.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 985.0, 794.0, 105.0, 29.0 ],
					"text" : "r init-bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 833.0, 837.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 809.5, 866.5, 66.0, 17.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 715.0, 858.0, 67.0, 34.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 617.0, 858.0, 76.0, 34.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.0, 848.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 162.0, 875.0, 66.0, 17.0 ],
					"text" : "gate 5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 320.0, 856.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 320.0, 883.0, 66.0, 17.0 ],
					"text" : "gate 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 494.0, 98.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 686.0, 561.0, 67.0, 29.0 ],
					"text" : "r stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 794.0, 119.0, 29.0 ],
					"text" : "r set-gate1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 794.0, 119.0, 29.0 ],
					"text" : "r set-gate3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 833.0, 794.0, 146.0, 29.0 ],
					"text" : "r set-counters"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 617.0, 794.0, 200.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.0, 794.0, 139.0, 29.0 ],
					"text" : "r reset-delay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 445.0, 875.0, 140.0, 29.0 ],
					"text" : "delay 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 150.0, 172.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 148.0, 248.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 613.0, 272.0, 111.0, 50.0 ],
					"text" : ";\rstop bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.5, 508.0, 71.0, 50.0 ],
					"text" : ";\rdac 0"
				}
...
,
					"patching_rect" : [ 34.0, 205.0, 106.0, 29.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"description" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.0, 388.0, 268.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 52.0, 845.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 794.0, 53.0, 29.0 ],
					"text" : "r dac"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 877.0, 52.0, 29.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.5, 508.0, 71.0, 50.0 ],
					"text" : ";\rdac 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 613.0, 199.0, 116.0, 50.0 ],
					"text" : ";\rstart bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 93.0, 1042.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 589.0, 123.0, 345.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 295.0, 238.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 682.0, 1074.0, 246.0 ],
					"rounded" : 0
				}
