...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 18.0, 79.0, 102.0, 17.0 ],
									"text" : "December 2008, mzed"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 18.0, 41.0, 256.0, 38.0 ],
									"text" : "August 2006 update of:\nwacom-osc by Matt Wright and Ali Momeni 12/17/00, 6/16/02\nby daniel cullen"
								}
...
,
					"patching_rect" : [ 501.5, 537.0, 46.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 577.0, 385.0, 109.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.0, 484.0, 19.0, 20.0 ],
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 484.0, 19.0, 20.0 ],
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 484.0, 19.0, 20.0 ],
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 375.0, 115.0, 22.0 ],
					"text" : "For Intous3:",
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 490.0, 18.0, 19.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 280.0, 27.0, 20.0 ],
					"text" : "0/1",
					"textcolor" : [ 1.0, 0.360784, 0.682353, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 115.0, 131.0, 22.0 ],
					"text" : "OSC MESSAGES:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 169.0, 245.0, 33.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "OSC-wacom", "OSC Wrapper for wacom tablets", "0.269 0.549 0.667 1." ],
					"id" : "obj-72",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "OSC-wacom.help", "1.0a", "M. Zbyszynski", "OSC-wacom", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-70",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 484.0, 19.0, 20.0 ],
					"text" : "x"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "OSC-wacom.maxpat",
				"bootpath" : "/Volumes/liferaid/DESKTOP/Coding/CNMAT-MMJ-Depot-WORKED/modules/Controllers/OSC-Wacom",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "keys.txt",
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/git/CNMAT-MMJ-Depot/examples/repertoire/Michael_Zbyszynski/NewsCycle#2",
				"patcherrelativepath" : "../../../../../../../../Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/git/CNMAT-MMJ-Depot/examples/repertoire/Michael_Zbyszynski/NewsCycle#2",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
