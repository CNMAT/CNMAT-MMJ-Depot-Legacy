...
, 			{
				"box" : 				{
					"args" : [ "OSC-STC-1000", "OSC wrapper patch for the Mercurial STC-1000 touchpad", "0.269 0.549 0.667 1." ],
					"id" : "obj-1",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "OSC-STC-1000.help", "1.1a", "M. Wright", "OSC-STC-1000", 2953, "0.269 0.549 0.667 1." ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 604.0, 292.0, 86.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 459.0, 37.0, 15.0 ],
					"text" : "$1 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 359.0, 507.0, 32.0, 17.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 359.0, 411.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 388.0, 92.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 359.0, 431.0, 34.0, 17.0 ],
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 359.0, 368.0, 53.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 334.0, 85.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.799988, 368.0, 196.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.600006, 368.0, 68.0, 15.0 ],
					"text" : "0, 2 10 1 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 459.0, 37.0, 15.0 ],
					"text" : "$1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 261.0, 480.0, 32.0, 17.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 261.0, 507.0, 40.0, 17.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 411.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 388.0, 87.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 431.0, 31.0, 17.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 368.0, 53.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.0, 334.0, 81.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 334.0, 78.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 284.0, 453.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "OSC-STC-1000.maxpat",
				"bootpath" : "/Volumes/liferaid/DESKTOP/Coding/CNMAT-MMJ-Depot-WORKED/modules/Controllers/OSC-STC-1000",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
