...
, 			{
				"box" : 				{
					"args" : [ "OSC-Wiiremote", "OSC wrapper for the wii remote via tha aka.wiiremote object", "0.269 0.549 0.667 1." ],
					"id" : "obj-5",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "OSC-Wiiremote.help", "1.0a", "M. Zbyszynski", "OSC-Wiiremote", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "o.route /X /Y /Z /orientation"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "o.route /A /B /1 /2 /plus /minus /left /right /up /down /home"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "official-wii-remote.jpg",
				"bootpath" : "/Volumes/liferaid/DESKTOP/Coding/CNMAT-MMJ-Depot-WORKED/modules/Controllers/OSC-Wiiremote",
				"patcherrelativepath" : ".",
				"type" : "JPEG",
				"implicit" : 1
			}
, 			{
				"name" : "OSC-Wiiremote.maxpat",
				"bootpath" : "/Volumes/liferaid/DESKTOP/Coding/CNMAT-MMJ-Depot-WORKED/modules/Controllers/OSC-Wiiremote",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
