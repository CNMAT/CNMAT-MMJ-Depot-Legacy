...
, 			{
				"box" : 				{
					"args" : [ "OSC-Xkeys-Stick.help", "1.1a", "M. Wright", "OSC-Xkeys-Stick", 2956, "0.517 0.512 0.638 1." ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 175.0, 305.0, 38.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/liferaid/DESKTOP/Coding/CNMAT-MMJ-Depot-WORKED/modules/Controllers/OSC-Xkeys-Stick",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
