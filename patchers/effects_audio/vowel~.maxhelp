...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 169.0, 166.0, 33.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "vowel~.help", "1.2a", " Zbyszynski, Wright", "vowel~", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-17",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 460.0, 298.0, 90.0 ]
				}
