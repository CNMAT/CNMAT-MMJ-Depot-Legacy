...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "pipe-any", "Like pipe but accepting lists and messages as well as floats and ints.", "0.517 0.512 0.638 1." ],
					"id" : "obj-1",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "pipe-any.help", "1.1b", " Wright & Zbyszynski", "pipe-any", 2529, "0.517 0.512 0.638 1." ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 175.0, 19.0, 18.0 ],
					"text" : "1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
