...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 373.0, 204.0, 20.0 ],
					"text" : "bangs when buffer finished playing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 217.5, 373.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 404.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 380.0, 26.0, 81.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 400.0, 182.0, 89.0 ],
					"text" : "*playbuf~ accepts both mono and stereo files.  mono files are output both L and R channels. When file is mono, single channel is sent out both channels"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 349.0, 204.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 661.0, 155.0, 216.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 104.0, 214.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 137.0, 349.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "playbuf~", "simple buffer playback with easy transposition in fractionalsemitones", "0.296 0.594 0.784 1." ],
					"id" : "obj-16",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "playbuf.help", 1.0, "Campion/Lubow", "playbuf.help", 7777, "0.296 0.594 0.784 1." ],
					"id" : "obj-17",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"name" : "playbuf~.maxpat",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Soundfiles-sampling",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "pizz.txt",
				"bootpath" : "/Applications/Max6/Cycling '74/externals/CNMAT-CNMAT-MMJ-Depot-7cfc1a0/media/Colls-Tables",
				"patcherrelativepath" : "../../../../../../../../Applications/Max6/Cycling '74/externals/CNMAT-CNMAT-MMJ-Depot-7cfc1a0/media/Colls-Tables",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
