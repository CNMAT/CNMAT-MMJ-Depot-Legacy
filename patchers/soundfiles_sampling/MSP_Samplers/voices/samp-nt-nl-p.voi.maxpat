...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 484.0, 216.0, 107.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 328.0, 75.0, 234.0, 17.0 ],
					"text" : "list: buffer (symbol) / vel (float 0-1) / pan (float-1 to 1)"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 188.0, 108.0, 72.0, 20.0 ],
					"text" : "unpack s f f"
				}
