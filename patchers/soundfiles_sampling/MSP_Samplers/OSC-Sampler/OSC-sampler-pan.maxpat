{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 170.0, 466.0, 1026.0, 493.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 632.0, 268.0, 104.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-36",
					"fontsize" : 12.0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 512.0, 272.0, 98.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-32",
					"fontsize" : 12.0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 408.0, 228.0, 302.0, 20.0 ],
					"numinlets" : 5,
					"id" : "obj-22",
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 740.0, 319.0, 606.0, 404.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 11.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.route /midinote-on /midinote-off /multisample /bank /refer /speaker /dbrange /busymap /noteon /noteoff /all-notes-off /panic /velmap /pan-or",
					"linecount" : 2,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"fontname" : "Arial",
