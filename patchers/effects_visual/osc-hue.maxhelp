...
, 			{
				"box" : 				{
					"args" : [ "osc-hue", "a simple osc wrapper around jit.hue", "0.296 0.594 0.784 1." ],
					"id" : "obj-23",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "osc-hue.help", "1.0a", "Rafael  Michael Zbyszynski", "osc-hue", 6666, "0.296 0.594 0.784 1." ],
					"id" : "obj-24",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 353.0, 469.0, 305.0, 84.0 ]
				}
