...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "_Music29_Lab_Tools", "This patch provides access to the LAB Software for Music 29.  The actual software is located in the CNMAT MaxMSPJitter Depot software and is dependent on the CNMAT everything Download" ],
					"hidden" : 1,
					"id" : "obj-42",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 496.0, 668.0, 308.0, 67.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "_Music29_Lab_Tools", "0.8a", "Campion & Lubow", "_Music29_Lab_Tools", 6666, "0.435 0.435 0.435 1." ],
					"hidden" : 1,
					"id" : "obj-12",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 496.0, 584.0, 297.0, 83.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 40.0, 278.0, 79.0 ],
...
,
					"patching_rect" : [ 100.0, 712.0, 65.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 680.0, 76.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 608.0, 185.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 296.0, 688.0, 79.0, 20.0 ],
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 734.0, 43.0, 17.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.0, 712.0, 63.0, 17.0 ],
					"text" : "prepend load"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 487.0, 201.0, 157.0 ],
					"tabcolor" : [ 0.156863, 0.356863, 0.466667, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 76.0, 476.0, 370.0 ],
					"rounded" : 15
				}
