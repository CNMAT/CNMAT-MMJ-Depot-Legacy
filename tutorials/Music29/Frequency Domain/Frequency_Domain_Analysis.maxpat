...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 427.0, 156.0, 0.0, 0.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 309.0, 257.0, 0.0, 0.0 ],
									"sig" : 0.0
								}
...
, 							{
								"box" : 								{
									...
									"text" : "route list active selwave"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 40.0, 110.0, 76.0, 20.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 97.0, 166.333313, 48.0, 18.0 ],
									"text" : "$1 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 97.0, 200.0, 50.0, 20.0 ],
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 40.0, 320.0, 76.0, 20.0 ],
									"text" : "*~ 0."
								}
...
,
					"patching_rect" : [ 444.0, 210.0, 55.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 531.0, 187.0, 53.0, 20.0 ],
					"prefix" : "selwave",
					"prefix_mode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 540.0, 200.0, 38.5, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 577.0, 380.0, 50.0, 20.0 ],
					"text" : "*~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 540.0, 230.0, 12.0, 116.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 558.5, 230.0, 20.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 215.0, 380.0, 42.0, 20.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 135.0, 37.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 163.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 120.0, 800.0, 59.0, 18.0 ],
									"text" : "active $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 120.0, 770.0, 42.0, 20.0 ],
									"text" : "active"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 690.0, 63.0, 20.0 ],
									"text" : "pack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 190.0, 680.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 33.0, 830.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 444.0, 187.0, 57.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 105.0, 47.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 583.5, 220.0, 47.0, 20.0 ],
					"text" : "mouse"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 444.0, 105.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 583.5, 200.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 466.0, 140.0, 44.0, 20.0 ],
					"text" : "freeze"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 511.0, 140.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 531.0, 232.0, 117.0, 37.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 17.5, 88.25, 131.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 350.0, 582.0, 32.5, 20.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 605.0, 63.0, 18.0 ],
					"text" : "hidden $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.75, 650.0, 41.0, 20.0 ],
					"text" : "y axis"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.0, 565.0, 41.0, 20.0 ],
					"text" : "x axis"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 240.0, 140.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 535.0, 150.0, 128.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 535.0, 103.0, 96.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 532.0, 103.0, 100.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 532.0, 80.0, 100.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 140.0, 223.0, 20.0 ],
					"text_width" : 132.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 1.0, 509.0, 81.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 308.0, 102.0, 200.0, 20.0 ],
					"tabs" : [ "stop", "play", "open" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 565.0, 349.5, 153.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 331.5, 80.0, 153.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 535.0, 360.0, 117.0, 77.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 605.0, 37.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 530.0, 656.0, 47.0, 21.0 ],
					"text" : "0 Hz"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 535.0, 445.0, 102.0, 192.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 425.0, 605.0, 66.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 530.0, 165.0, 67.0, 21.0 ],
					"text" : "15000 Hz"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 165.0, 524.0, 512.0 ],
					"range" : [ 0.0, 1.068065 ],
					"rounded" : 0,
					"scroll" : 3,
					"sono" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 285.0, 76.5, 355.5, 50.5 ],
					"rounded" : 16
				}
