...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "03-OSC-vs-pattr", 1.1, "Valle, Freed & Zbyszinski", "03-OSC-vs-pattr", 6666, "0.5 0.5 0.5 0.5." ],
					"id" : "obj-33",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 519.0, 23.0, 297.0, 83.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "03-OSC-vs-pattr", "Compares OSC and pattr", "0.5 0.5 0.5 0.5" ],
					"id" : "obj-1",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 13.0, 23.0, 507.0, 79.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 178.0, 270.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 70.0, 94.0, 19.0, 18.0 ],
									"text" : "0"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 130.0, 270.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 374.0, 126.0, 34.0 ],
					"text" : "This abstraction does the translation work."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 122.0, 291.0, 113.0 ],
					"rounded" : 20,
					"shadow" : 2
				}
...
, 			{
				...
				"patcherrelativepath" : "../../modules/Data_Transformation/OSC-vs-pattr",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
