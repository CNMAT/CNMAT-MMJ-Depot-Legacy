...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 750.0, 271.0, 100.0, 191.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "string_stopped", "1.0alpha", "Valle and Zbyszynski", "string_stopped", 3023, "0.5 0.5 0.5 0.5" ],
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 608.0, 15.0, 297.0, 91.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "+string_example_stopped", "Stopped string example based on Pythagoras", "0.5 0.5 0.5 0.5" ],
					"id" : "obj-42",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 150.0, 16.0, 460.0, 72.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 790.5, 238.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 750.0, 210.0, 96.0, 20.0 ],
