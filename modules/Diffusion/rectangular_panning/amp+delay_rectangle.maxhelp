...
, 			{
				"box" : 				{
					"args" : [ "amp+delay_rectangle.help", "1.5b", "Valle, Zbyszynski", "amp+delay_rectangle", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.0, 658.0, 29.0, 34.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 658.0, 29.0, 34.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.0, 658.0, 29.0, 34.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 658.0, 29.0, 34.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 368.0, 29.0, 34.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 598.0, 368.0, 29.0, 34.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 598.0, 147.0, 29.0, 34.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 147.0, 29.0, 34.0 ],
					"text" : "1"
				}
...
, 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Diffusion/rectangular_panning",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
