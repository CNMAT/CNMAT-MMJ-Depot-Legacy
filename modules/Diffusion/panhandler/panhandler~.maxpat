...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 309.0, 122.0, 119.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.0, 143.0, 47.0, 17.0 ],
					"text" : "print ••"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 309.0, 98.0, 100.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 162.0, 163.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 185.0, 69.0, 17.0 ],
					"text" : "print • error"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 60.0, 51.0, 58.0, 17.0 ],
					"text" : "sel \\\"#1\\\" 0"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 120.0, 84.0, 91.0, 17.0 ],
...
,
					"patching_rect" : [ 108.0, 111.0, 42.0, 17.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"tags" : "",
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 22.0, 67.0, 17.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 108.0, 135.0, 61.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 237.0, 161.0, 54.0, 17.0 ],
					"text" : "pancore 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.5, 276.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 237.0, 276.0, 84.0, 17.0 ],
					"text" : "matrix~ 1 #1 0.",
					"varname" : "ph-matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 109.0, 36.0, 15.0 ],
					"text" : "signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 237.0, 71.0, 63.0, 17.0 ],
					"text" : "route signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 42.0, 15.0, 15.0 ]
				}
