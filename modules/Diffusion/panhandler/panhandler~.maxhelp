...
, 			{
				"box" : 				{
					"args" : [ "panhandler~", "controls panning: 1 in x (4-8) out", "0.296 0.594 0.784 1." ],
					"id" : "obj-2",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "panhandler~.help", "1.5a", "Valle and Zbyszynski", "panhandler~", 2861, "0.296 0.594 0.784 1." ],
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 							{
								"box" : 								{
									...
									"text" : "/define_loudspeakers 2 -45 0 45 90 135 180 225 270"
								}
