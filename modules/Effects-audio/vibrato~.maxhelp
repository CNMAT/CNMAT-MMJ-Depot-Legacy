...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 200.0, 167.0, 48.0 ],
					"text" : "NB: this works a bit better if the signal vector is low... <512 or better. -mz"
				}
...
, 			{
				"box" : 				{
					"args" : [ "vibrato~.help", "1.1a", "Valle, Zbyszynski, Wright", "vibrato~", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-12",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
