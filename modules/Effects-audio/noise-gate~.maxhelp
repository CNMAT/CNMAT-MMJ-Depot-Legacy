...
, 			{
				"box" : 				{
					"args" : [ "noise-gate~", "simple noise gate", "0.296 0.594 0.784 1." ],
					"id" : "obj-20",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "noise-gate~.help", "1.0a", "Valle, Zbyszynski, Wright", "noise-gate~", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-21",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 342.0, 301.0, 86.0 ]
				}
