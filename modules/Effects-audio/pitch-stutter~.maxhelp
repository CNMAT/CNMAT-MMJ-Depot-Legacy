...
, 			{
				"box" : 				{
					"args" : [ "pitch-stutter~", "pitchshift and stutter", "0.296 0.594 0.784 1." ],
					"id" : "obj-3",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 23.0, 5.0, 511.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.0, 294.0, 54.0, 20.0 ],
					"text" : "preset 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 330.0, 296.0, 18.0, 34.0 ],
					"size" : 2,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					"args" : [ "pitch-stutter~.help", "1.3b", "Valle and Zbyszynski", "pitch-stutter~", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-35",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.0, 311.0, 54.0, 20.0 ],
					"text" : "preset 2"
				}
