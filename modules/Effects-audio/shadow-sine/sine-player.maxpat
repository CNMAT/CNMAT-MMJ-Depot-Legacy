...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 223.0, 283.5, 20.0 ],
					"text" : "add some randomness, basd on the freq-dist factor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 281.0, 177.0, 53.0, 20.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 281.0, 250.0, 53.0, 20.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 223.0, 63.0, 20.0 ],
					"text" : "ranab 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 223.0, 34.0, 20.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 9.0, 36.0, 173.0, 20.0 ],
					"text" : "route look-for play freq-dist"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 199.5, 165.0, 96.0, 165.0, 96.0, 94.0, 112.5, 94.0 ],
					"source" : [ "obj-11", 4 ]
				}
