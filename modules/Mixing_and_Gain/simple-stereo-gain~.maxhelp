...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.0, 387.0, 81.0, 19.0 ],
					"text" : "send~ toRecR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 387.0, 79.0, 19.0 ],
					"text" : "send~ toRecL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 223.0, 114.264709, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 183.0, 124.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 99.0, 83.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 99.0, 33.0, 16.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 292.0, 139.0, 180.0, 18.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "simple-stereo-gain~", 1.1, "Jeff Lubow", "simple-stereo-gain~", 6666, "0.1 0.1 0.1 0.5" ],
					"id" : "obj-36",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 163.0, 174.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 195.0, 208.0, 94.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "simple-stereo-gain~", "Play audio out two channels", "0.1 0.1 0.1 0.5" ],
					"id" : "obj-28",
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					"numinlets" : 0,
