...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.0, 704.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 772.5, 78.0, 18.0 ],
					"text" : "print osc_mess"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 736.0, 44.0, 18.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.0, 704.0, 32.0, 18.0 ],
					"text" : "r osc"
				}
...
, 			{
				"box" : 				{
					"args" : [ "cue_button", "set up cues for events to be triggered in max namespace", "0.296 0.594 0.784 1." ],
					"embed" : 1,
					"id" : "obj-42",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 570.0, 111.0, 123.0, 20.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 169.0, 284.0, 17.0 ],
									"text" : "loadmess #2"
								}
...
, 			{
				"box" : 				{
					"args" : [ "cue button", 1.0, "Jeff Lubow / Edmund Campion", "cue button", 6666, "0.296 0.594 0.784 1." ],
					"id" : "obj-41",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cue_button.maxpat",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Interface/cue_button",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
