...
,
					"patching_rect" : [ 699.5, 757.0, 46.0, 17.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "multibuf", "this abstraction helps you read sound files into buffer~'s", "0.296 0.594 0.784 1." ],
					"id" : "obj-18",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -18.0, -68.0 ],
					"patching_rect" : [ 9.0, 16.0, 511.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "multibuf.help", "1.7b", "Valle, Momeni, Wright, mzed", "multibuf", 2813, "0.296 0.594 0.784 1." ],
					"id" : "obj-25",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
