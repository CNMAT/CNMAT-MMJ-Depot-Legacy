...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-14",
					"items" : [ "floisen_blutter", ",", "floisen_metail", ",", "floisen_noisen", ",", "floisen_ruff01", ",", "floisen_ruff02", ",", "floisen_wind" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 280.0, 226.0, 20.0 ],
					"text" : "polybufferhelper asdf @name mybufs",
