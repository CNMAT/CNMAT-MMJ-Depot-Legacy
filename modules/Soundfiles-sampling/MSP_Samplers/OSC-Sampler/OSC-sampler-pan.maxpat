...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 416.0, 34.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.0, 384.0, 34.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 896.0, 424.0, 25.0, 25.0 ]
				}
...
,
					"patching_rect" : [ 632.0, 276.0, 104.0, 20.0 ],
...
,
					"patching_rect" : [ 512.0, 276.0, 98.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontface" : 0,
						"fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 200.0, 284.0, 32.5, 20.0 ],
									"text" : "+ 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 308.0, 66.0, 20.0 ],
									"text" : "clip -64 64"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 16.0, 332.0, 201.0, 20.0 ],
									"text" : "pack s f i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 16.0, 260.0, 298.0, 20.0 ],
									"text" : "unpack s i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 292.0, 296.0, 87.0, 20.0 ],
									"text" : "midivel2gain"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 132.0, 188.0, 85.0, 20.0 ],
									"text" : "sprintf %d-%d"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 132.0, 156.0, 85.0, 20.0 ],
									"text" : "unpack i i"
								}
...
,
					"patching_rect" : [ 412.0, 228.0, 302.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontface" : 0,
						"fontface" : 0,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 235.0, 261.0, 92.0, 20.0 ],
									"text" : "prepend voices"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 261.0, 128.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 336.0, 260.0, 81.0, 20.0 ],
									"text" : "prepend args"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 48.0, 148.0, 46.0, 20.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 208.0, 50.0, 18.0 ],
									"text" : "16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 64.0, 200.0, 82.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 336.0, 236.0, 50.0, 18.0 ],
									"text" : "#0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 104.0, 36.0, 25.0, 25.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 577.0, 60.0, 129.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 744.0, 425.0, 25.0, 25.0 ]
				}
...
,
					...
					"patching_rect" : [ 592.0, 392.0, 323.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "OSC-route /midinote-on /midinote-off /multisample /bank /refer /speaker /dbrange /busymap /noteon /noteoff /all-notes-off /panic /velmap /pan-or"
				}
