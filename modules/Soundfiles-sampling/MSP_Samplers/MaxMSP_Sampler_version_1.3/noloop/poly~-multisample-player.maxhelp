...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "poly~-multisample-player", 1.2, "Valle & Wright", "poly~-multisample-player", 6666, "0.38 0.612 0.612 0.5" ],
					"id" : "obj-42",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 184.0, 106.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 57.0, 307.0, 270.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 373.0, 291.0, 62.0, 23.0 ],
					"text" : "multibuf"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 141.0, 270.0, 47.0, 23.0 ],
					"triscale" : 0.9
				}
