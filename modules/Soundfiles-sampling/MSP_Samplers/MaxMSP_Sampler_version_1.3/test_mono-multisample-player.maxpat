...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "test_mono-multisample-player", 1.2, "Valle & Wright", "test_mono-multisample-player", 6666, "0.38 0.612 0.612 0.5" ],
					"embed" : 1,
					"id" : "obj-42",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 409.0, 15.0, 170.0, 17.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 514.0, 54.0, 112.0, 17.0 ],
									"text" : "loadmess #3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 7.0, 15.0, 264.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 7.0, 2.0, 280.0, 16.0 ],
									"text" : "test_mono-multisample-player version 1.2 by Valle & Wright",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 190.0, 269.0, 226.0, 15.0 ],
...
,
					"patching_rect" : [ 228.5, 397.0, 297.0, 83.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "test_mono-multisample-player", "Test the functionalities of the mono-multisample-player", "0.38 0.612 0.612 0.5" ],
					"embed" : 1,
					"id" : "obj-43",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 570.0, 111.0, 225.0, 20.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Test the functionalities of the mono-multisample-player",
									"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
									"varname" : "myName"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 169.0, 274.0, 17.0 ],
									"text" : "loadmess #2"
								}
...
,
					"patching_rect" : [ 5.0, 5.0, 508.0, 76.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 857.0, 753.0, 511.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 278.0, 331.0, 70.0, 17.0 ],
					"text" : "prepend /coll"
				}
...
,
					"patching_rect" : [ 278.0, 272.0, 85.0, 17.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"default_fontface" : 0,
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 272.0, 117.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 329.0, 305.0, 136.0, 17.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 119.0, 149.0, 92.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 51.0, 282.0, 35.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 55.0, 149.0, 40.0, 17.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 145.0, 282.0, 47.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 355.0, 200.0, 53.0, 27.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 300.0, 200.0, 27.0, 17.0 ],
					"text" : "* 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 168.0, 85.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 300.0, 147.0, 36.0, 17.0 ],
					"text" : "bendin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 237.0, 145.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 51.0, 213.0, 49.0, 17.0 ],
					"text" : "stripnote"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 98.0, 213.0, 44.0, 17.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 55.0, 186.0, 45.0, 17.0 ],
					"text" : "poly 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 278.0, 361.0, 63.0, 23.0 ],
					"text" : "multibuf"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 105.0, 196.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 193.0, 282.0, 35.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 98.0, 282.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 52.0, 351.0, 27.0, 82.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 443.0, 29.0, 17.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 405.0, 26.0, 26.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 51.0, 316.0, 198.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 186.0, 58.0, 17.0 ],
					"text" : "bend range"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 196.0, 106.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 101.0, 100.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 85.0, 130.0, 17.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 309.5, 259.0, 202.5, 259.0 ],
					"source" : [ "obj-12", 0 ]
				}
