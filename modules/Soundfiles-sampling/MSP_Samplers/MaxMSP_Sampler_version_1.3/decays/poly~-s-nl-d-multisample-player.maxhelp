...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "poly~-s-nl-d-multisample-player", 1.3, "Valle & Wright", "poly~-s-nl-d-multisample-player", 6666, "0.38 0.612 0.612 0.5" ],
					"id" : "obj-17",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 166.5, 530.0, 297.0, 83.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 570.0, 111.0, 231.0, 20.0 ],
									"text" : "loadmess #1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 169.0, 288.0, 17.0 ],
									"text" : "loadmess #2"
								}
...
,
					"patching_rect" : [ 16.0, -4.0, 508.0, 76.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 278.0, 89.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 255.0, 89.0, 15.0 ],
					"text" : "10. 0.5 1000. 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 93.0, 505.0, 27.0, 82.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 164.5, 354.5, 130.0, 130.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 354.5, 130.0, 130.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 329.0, 68.0, 17.0 ],
					"text" : "prepend /coll"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 192.0, 106.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 312.0, 236.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.0, 558.0, 26.0, 26.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 599.0, 29.0, 17.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 505.0, 27.0, 82.0 ],
					"stripecolor" : [ 0.66667, 0.66667, 0.66667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 257.0, 107.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 308.0, 353.0, 62.0, 23.0 ],
					"text" : "multibuf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 211.0, 40.0, 17.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 115.0, 210.0, 44.0, 17.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 233.0, 135.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 278.0, 47.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 138.0, 40.0, 17.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 308.0, 384.0, 123.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 125.0, 148.0, 92.0, 17.0 ],
