...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "OSC-pc1600", "OSC wrapper for the Peavy PC-1600 or PC1600x MIDI command station", "0.517 0.512 0.638 1." ],
					"id" : "obj-47",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "OSC-pc1600.help", "1.2b", "Valle, Wright & Zbyszynski", "OSC-pc1600", 2849, "0.517 0.512 0.638 1." ],
					"id" : "obj-4",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "OSC-pc1600.maxpat",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Controllers/OSC-pc1600",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
