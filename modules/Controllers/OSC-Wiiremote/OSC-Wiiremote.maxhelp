...
, 			{
				"box" : 				{
					"args" : [ "OSC-Wiiremote.help", "1.0a", "R. Valle & M. Zbyszynski", "OSC-Wiiremote", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Controllers/OSC-Wiiremote",
				"patcherrelativepath" : "",
				"type" : "JPEG",
				"implicit" : 1
			}
