...
, 			{
				"box" : 				{
					"args" : [ "OSC-BU-353.help", "1.0a", "R. Valle and M. Zbyszynski", "OSC-BU-353", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-31",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 105.0, 124.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 134.0, 111.0, 34.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Controllers/OSC-BU-353",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "strjoin.js",
				"bootpath" : "/Applications/Max6/examples/javascript/lists+strings",
				"patcherrelativepath" : "../../../../../../../../../Applications/Max6/examples/javascript/lists+strings",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
