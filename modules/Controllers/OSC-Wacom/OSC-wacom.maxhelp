...
, 							{
						...
						"dependency_cache" : [ 							{
								"name" : "keys.txt",
								"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/repertoire/Michael_Zbyszynski/NewsCycle#2",
								"type" : "TEXT",
								"implicit" : 1
							}
, 							{
...
, 			{
				"box" : 				{
					"args" : [ "OSC-wacom.help", "1.0a", "R. Valle and M. Zbyszynski", "OSC-wacom", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-70",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Controllers/OSC-Wacom",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "keys.txt",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/repertoire/Michael_Zbyszynski/NewsCycle#2",
				"patcherrelativepath" : "../../../repertoire/Michael_Zbyszynski/NewsCycle#2",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
