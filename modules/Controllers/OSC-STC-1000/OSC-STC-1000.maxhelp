...
, 			{
				"box" : 				{
					"args" : [ "OSC-STC-1000.help", "1.1a", "R.Valle and M. Wright", "OSC-STC-1000", 2953, "0.269 0.549 0.667 1." ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Controllers/OSC-STC-1000",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
