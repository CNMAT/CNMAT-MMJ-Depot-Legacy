...
, 			{
				"box" : 				{
					"args" : [ "tempo~", "a phasor~-based metronome", "0.296 0.594 0.784 1." ],
					"id" : "obj-4",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "tempo~.help", "3.1b", "Valle and Zbyszynski", "tempo~", 2964, "0.296 0.594 0.784 1." ],
					"id" : "obj-5",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 631.0, 526.0, 309.0, 89.0 ]
				}
