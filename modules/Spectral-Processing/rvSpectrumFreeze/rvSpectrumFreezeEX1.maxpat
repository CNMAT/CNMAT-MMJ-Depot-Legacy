...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 597.0, 86.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.0, 118.0, 92.0, 20.0 ],
					"text" : "loadmess 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 179.0, 138.0, 50.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.0, 171.0, 176.0, 20.0 ],
					"text" : "pfft~ rvSpectrumFreeze 4096 4"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "rvSpectrumFreeze.maxpat",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/PIP/rvSpectrum/rvSpectrumFreeze",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
