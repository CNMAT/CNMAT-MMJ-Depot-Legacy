...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1122.0, 309.0, 42.0, 20.0 ],
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1047.0, 426.0, 34.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 998.0, 309.0, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 998.0, 369.0, 123.0, 20.0 ],
					"text" : "expr $f1*(100./4096.)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1022.0, 501.0, 211.0, 67.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 567.0, 86.0, 242.0, 56.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 256
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 913.0, 221.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 281.0, 155.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 567.0, 37.0, 80.0, 20.0 ],
					"text" : "TYPE"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 301.0, 155.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 680.0, 37.0, 50.0, 20.0 ],
					"text" : "STEP"
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.99024, 0.995289, 0.990099, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"hint" : "Amplitude [0,1]",
					"id" : "obj-3",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1122.0, 268.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 680.0, 59.0, 50.0, 20.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 913.0, 285.0, 75.0, 20.0 ],
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1077.0, 342.0, 64.0, 20.0 ],
					"text" : "drunk 100"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-23",
					"items" : [ "Random", ",", "Urn", ",", "Drunken", "walk" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 913.0, 190.0, 127.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 567.0, 59.0, 100.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 998.0, 342.0, 68.0, 20.0 ],
					"text" : "urn 4096 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 321.0, 155.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 747.5, 37.0, 64.0, 20.0 ],
					"text" : "CREATE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 913.0, 415.0, 41.0, 20.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 913.0, 442.0, 83.0, 20.0 ],
					"text" : "zl.group 4096"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 969.0, 221.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 762.5, 59.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 913.0, 342.0, 75.0, 20.0 ],
					"text" : "random 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 969.0, 254.0, 56.0, 20.0 ],
					"text" : "uzi 4096"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 139.0, 68.0, 20.0 ],
					"text" : "r #0-shape"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 913.0, 557.0, 70.0, 20.0 ],
					"text" : "s #0-shape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 913.0, 531.0, 63.0, 20.0 ],
					"text" : "pack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 913.0, 501.0, 94.0, 20.0 ],
					"text" : "counter 0. 4095"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 913.0, 471.0, 27.0, 20.0 ],
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"framecolor" : [ 0.501961, 0.501961, 0.501961, 0.0 ],
					"id" : "obj-37",
					"items" : [ "Output", "off", ",", "Source", ",", "Random" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.0, 165.0, 184.0, 20.0 ],
					"text" : "pfft~ rvSpectrumRandom 4096 4"
				}
...
, 			{
				"box" : 				{
					...
					"grad2" : [ 0.86981, 0.901165, 0.381697, 1.0 ],
					"id" : "obj-24",
					"ignoreclick" : 1,
					"maxclass" : "panel",
					"mode" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1007.5, 333.5, 1007.5, 333.5 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "rvSpectrumRandom.maxpat",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/PIP/rvSpectrum/rvSpectrumRandom",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
