...
, 			{
				"box" : 				{
					"args" : [ "dsp_session", "0.1a", "Jeff Lubow", "dsp_session", 6666 ],
					"id" : "obj-6",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/git/CNMAT-MMJ-Depot/modules/utilities/dsp_session",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
