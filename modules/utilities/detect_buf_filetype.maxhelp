...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 390.0, 130.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 150.0, 280.0, 65.0, 20.0 ],
					"text" : "route path"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 143.0, 234.0, 24.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "detect_buf_filetype", "detect a chosen sound's filetype and output appropriate buffer~ messages" ],
					"embed" : 1,
					"id" : "obj-27",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 350.0, 84.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.0, 240.0, 111.0, 20.0 ],
					"text" : "detect_buf_filetype"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 196.0, 350.0, 88.0, 21.0 ],
					"text" : "buffer~ dbf -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 140.0, 130.0, 50.0, 50.0 ]
				}
