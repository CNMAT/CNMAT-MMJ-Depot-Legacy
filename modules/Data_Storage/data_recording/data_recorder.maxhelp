...
, 			{
				"box" : 				{
					"args" : [ "data_recorder", "record one data stream into a collection and play it back", "0.296 0.594 0.784 1." ],
					"id" : "obj-1",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "data_recorder.help", "1.2a", "Valle and Zbyszynski", "data_recorder", 3037, "0.296 0.594 0.784 1." ],
					"id" : "obj-10",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 265.0, 110.0, 34.0 ],
