...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "enveloped-recorder~.help", "1.1a", "Valle and Wright", "enveloped-recorder~", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-18",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Data_Storage/enveloped-recorder~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
