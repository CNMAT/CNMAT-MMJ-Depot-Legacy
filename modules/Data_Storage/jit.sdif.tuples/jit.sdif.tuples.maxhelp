...
, 			{
				"box" : 				{
					"args" : [ "jit.sdif.tuples.help", "0.2b", "Valle and Zbyszynski", "jit.sdif.tuples", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-21",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Data_Storage/jit.sdif.tuples",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
