...
,
					"patching_rect" : [ 322.0, 486.0, 46.0, 17.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "rzcalib.help", "1.1b", "Valle and Zbyszynski", "rzcalib", 2824, "0.517 0.512 0.638 1." ],
					"id" : "obj-53",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "rzcalib", "adjusts a running stream of numbers to the required range *and* adjusts the zero point", "0.517 0.512 0.638 1." ],
					"id" : "obj-48",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 333.0, 126.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 288.0, 164.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 313.0, 123.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 269.0, 136.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 246.0, 110.0, 23.0 ],
					"text" : "3) Sweep to low",
					"textcolor" : [ 0.6, 0.6, 0.701961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 222.0, 116.0, 23.0 ],
