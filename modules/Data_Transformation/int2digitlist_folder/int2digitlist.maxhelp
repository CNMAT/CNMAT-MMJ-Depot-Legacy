...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "int2digitlist", 1.0, "Matt Wright / Jeff Lubow", "int2digitlist", 6666, "0.1 0.1 0.1 1." ],
					"id" : "obj-21",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "int2digitlist", "intput int output as its components", "0.1 0.1 0.1 1." ],
					"id" : "obj-19",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Data_Transformation/int2digitlist_folder",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
