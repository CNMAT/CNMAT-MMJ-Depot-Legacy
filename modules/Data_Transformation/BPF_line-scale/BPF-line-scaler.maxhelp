...
, 			{
				"box" : 				{
					"args" : [ "BPF-line-scaler", "takes a break point function line message and scales it to fit a desired overall length in ms", "0.296 0.594 0.784 1." ],
					"id" : "obj-17",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					"args" : [ "BPF-line-scaler.help", "0.1a", "Campion", "BPF-line-scaler.help", 2512, "0.296 0.594 0.784 1." ],
					"id" : "obj-18",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				...
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/modules/Data_Transformation/BPF_line-scale",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
