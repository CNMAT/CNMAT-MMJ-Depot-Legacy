...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 105.5, 264.0, 256.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 31.5, 218.0, 256.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 200.0, 60.0, 182.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 244.0, 234.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 221.0, 218.0, 236.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 31.5, 158.0, 279.5, 18.0 ],
									"text" : "sel 1 0"
								}
...
,
					"patching_rect" : [ 280.0, 209.0, 208.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.445652, 0.445652, 0.445652, 1.0 ],
					"bufsize" : 64,
					"calccount" : 64,
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 281.75, 244.0, 19.5, 16.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 352.0, 172.0, 83.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 469.0, 291.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.5, 244.0, 96.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 142.0, 70.868416, 16.0 ],
					"text" : "audio off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 374.5, 264.0, 22.0, 18.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 219.5, 79.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.862764, 162.0, 96.0, 13.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 323.0, 55.0, 18.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 168.0, 244.0, 38.0, 18.0 ],
					"text" : "t open"
				}
