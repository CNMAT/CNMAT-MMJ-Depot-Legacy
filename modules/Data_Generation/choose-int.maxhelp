...
, 			{
				"box" : 				{
					"args" : [ "choose-int", 1.0, "Rafael Valle and Matt Wright", "choose-int", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "choose-int", "choose a single integer between 1-9 using multiple specification criteria", "0.269 0.549 0.667 1." ],
					"id" : "obj-1",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 273.0, 394.0, 23.0 ],
