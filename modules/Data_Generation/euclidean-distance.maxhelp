...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "Euclidean Distance", "Calculate the square root of the sum of squared differences", "0.269 0.549 0.667 1." ],
					"id" : "obj-42",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -68.0 ],
					"patching_rect" : [ 19.0, 5.0, 506.0, 77.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "euclidian-distance", "1.1a", "Valle, Wright & Zbyszynski", "euclidian-distance", 6666, "0.269 0.549 0.667 1." ],
					"id" : "obj-30",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 168.0, 19.0, 20.0 ],
					"text" : "c"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 425.0, 202.0, 19.0, 20.0 ],
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 221.0, 387.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 145.0, 273.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 460.0, 204.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 158.0, 65.0, 18.0 ],
					"text" : "2 3 4 5 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 158.0, 65.0, 18.0 ],
					"text" : "1 2 3 4 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 181.0, 19.0, 20.0 ],
					"text" : "a"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 400.0, 201.5, 469.0, 201.5 ],
					"source" : [ "obj-15", 0 ]
				}
