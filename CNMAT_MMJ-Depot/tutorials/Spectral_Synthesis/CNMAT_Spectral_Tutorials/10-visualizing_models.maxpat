{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 46.0, 855.0, 665.0 ],
		"bgcolor" : [ 0.972549, 0.972549, 0.784314, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 46.0, 855.0, 665.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 1.0, 2.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 7.0, 816.0, 100.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "select a new note name style:",
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 27.0, 487.0, 191.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"types" : [  ],
					"fontsize" : 12.0,
					"patching_rect" : [ 28.0, 504.0, 162.0, 18.0 ],
					"outlettype" : [ "int", "", "" ],
					"pattrmode" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "If you click and drag on the resonance-display, you'll see the numbers changing. The numbers in the upper left and right corners represent the frequencies of the left and right vertical lines.",
					"linecount" : 4,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 8.0, 387.0, 264.0, 54.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-4",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "In the center, you'll see frequency difference in Hz and as note name, and the number of selected partials / total number",
					"linecount" : 3,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 8.0, 442.0, 241.0, 42.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-5",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 548.0, 561.0, 64.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 409.0, 314.0, 125.0, 16.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 604.0, 564.0, 31.0, 16.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Resonance-display can also be used to edit, as we'll see in later tutorials. It is written in Javascript in works with Max's jsui object.",
					"linecount" : 2,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 199.0, 553.0, 355.0, 30.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-9",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 722.0, 270.0, 100.0, 18.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-10",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "adjust the range of displayed freqencies",
					"linecount" : 2,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 530.0, 281.0, 121.0, 30.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-11",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 314.0, 256.0, 41.0, 16.0 ],
					"outlettype" : [ "" ],
					"bgcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"fontsize" : 12.0,
					"patching_rect" : [ 313.0, 277.0, 67.0, 18.0 ],
					"outlettype" : [ "", "", "", "" ],
					"id" : "obj-13",
					"fontname" : "Helvetica",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 395.0, 277.0, 119.0, 16.0 ],
					"outlettype" : [ "" ],
					"bgcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-14",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 401.0, 295.0, 125.0, 16.0 ],
					"outlettype" : [ "" ],
					"bgcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-15",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 706.0, 454.0, 16.0, 17.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 706.0, 442.0, 16.0, 17.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 703.0, 459.0, 18.0, 20.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 703.0, 460.0, 18.0, 20.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 706.0, 430.0, 16.0, 17.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 707.0, 397.0, 16.0, 17.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 707.0, 385.0, 16.0, 17.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 704.0, 360.0, 18.0, 20.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 704.0, 348.0, 18.0, 20.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 694.0, 411.0, 131.0, 20.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 400.0, 341.0, 202.0, 20.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 685.0, 269.0, 41.0, 16.0 ],
					"outlettype" : [ "" ],
					"bgcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-27",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"fontsize" : 12.0,
					"patching_rect" : [ 685.0, 291.0, 61.0, 18.0 ],
					"outlettype" : [ "", "", "", "" ],
					"id" : "obj-28",
					"fontname" : "Helvetica",
					"color" : [ 1.0, 0.890196, 0.090196, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "jsui",
					"numoutlets" : 2,
					"patching_rect" : [ 313.0, 361.0, 381.0, 117.0 ],
					"outlettype" : [ "", "" ],
					"jsarguments" : [  ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "We've also been able to read the data from a model inside of collections or message boxes.",
					"linecount" : 2,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 18.0, 243.0, 279.0, 30.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-30",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"fontsize" : 18.0,
					"patching_rect" : [ 441.0, 170.0, 173.0, 27.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-31",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 104.0, 205.0, 19.0, 18.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-32",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "(click on the word to see the help file)",
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 31.0, 229.0, 239.0, 18.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-33",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"patching_rect" : [ 6.0, 319.0, 47.0, 17.0 ],
					"hidden" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-34",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"patching_rect" : [ 6.0, 294.0, 66.0, 17.0 ],
					"hidden" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-35",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 126.0, 205.0, 98.0, 16.0 ],
					"outlettype" : [ "" ],
					"bgcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 48.0, 205.0, 52.0, 16.0 ],
					"outlettype" : [ "" ],
					"bgcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-37",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"patching_rect" : [ 662.0, 656.0, 47.0, 17.0 ],
					"hidden" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-38",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 9.0,
					"patching_rect" : [ 21.0, 656.0, 61.0, 17.0 ],
					"hidden" : 1,
					"outlettype" : [ "", "" ],
					"id" : "obj-39",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -39.0 ],
					"numoutlets" : 2,
					"patching_rect" : [ 21.0, 610.0, 779.0, 35.0 ],
					"outlettype" : [ "", "" ],
					"lockeddragscroll" : 1,
					"id" : "obj-40",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"patching_rect" : [ 21.0, 588.0, 83.0, 17.0 ],
					"hidden" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-41",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"fontsize" : 18.0,
					"patching_rect" : [ 17.0, 136.0, 184.0, 27.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-43",
					"fontname" : "Trebuchet MS",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "In previous tutorials, we've used standard Max objects to display the output of sinusoids~, decaying-sinusoids~, and resonators~. These are:",
					"linecount" : 3,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 19.0, 162.0, 278.0, 42.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-44",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "To visualize a resonance model before it is synthesized, use resonance-display.",
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 362.0, 199.0, 435.0, 18.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-45",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<-- click to dump the model into resonance-display",
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 357.0, 252.0, 278.0, 18.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-46",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 707.0, 373.0, 16.0, 17.0 ],
					"frgb" : [ 0.4, 0.4, 0.8, 1.0 ],
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"id" : "obj-47",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The top of each line is its amplitude. The length of the line represents decayrate.",
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 321.0, 490.0, 494.0, 18.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-48",
					"fontname" : "Helvetica",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Those pink numbers",
					"numoutlets" : 0,
					"fontface" : 1,
					"fontsize" : 14.0,
					"patching_rect" : [ 37.0, 364.0, 157.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 4.0, 365.0, 276.0, 165.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bordercolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"patching_rect" : [ 189.0, 546.0, 450.0, 50.0 ],
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"rounded" : 15,
					"shadow" : 2,
					"id" : "obj-51",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bordercolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"patching_rect" : [ 13.0, 134.0, 284.0, 147.0 ],
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"rounded" : 15,
					"shadow" : 2,
					"id" : "obj-52",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bordercolor" : [ 0.4, 0.4, 0.8, 1.0 ],
					"patching_rect" : [ 304.0, 152.0, 524.0, 368.0 ],
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"rounded" : 15,
					"shadow" : 2,
					"id" : "obj-53",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-29", 0 ],
					"hidden" : 0,
					"midpoints" : [ 646.0, 324.0, 397.0, 339.0 ]
				}
