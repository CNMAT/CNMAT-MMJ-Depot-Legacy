{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 80.0, 44.0, 640.0, 506.0 ],
		"bglocked" : 0,
		"defrect" : [ 80.0, 44.0, 640.0, 506.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 341.0, 85.0, 20.0 ],
					"text" : "No difference!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 337.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "int" ],
					"patching_rect" : [ 70.0, 242.0, 43.0, 82.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 143.0, 57.0, 18.0 ],
					"text" : "loop 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 28.0, 146.0, 46.0, 20.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 392.0, 151.0, 20.0 ],
					"text" : "buffer~ burning burning.aif"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.0, 170.0, 98.0, 20.0 ],
					"text" : "groove~ burning"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 140.0, 327.0, 48.0 ],
					"text" : "For realtime use, we want to do a \"fast fourier transform\" or FFT. The easiest way to do this transform in MSP is the pfft~ object."
				}

			}
, 			{
				"box" : 				{
					"color" : [ 1.0, 0.952941, 0.192157, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-8",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 41.0, 198.0, 110.0, 20.0 ],
					"text" : "pfft~ basic-fft 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 119.0, 62.0, 23.0 ],
					"text" : "In MSP:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 53.0, 492.0, 62.0 ],
					"text" : "The mathematics behind the shift from the time domain to the frequency domain is the \"fourier transform.\"  The mathematically inclined might want to check out: http://mathworld.wolfram.com/FourierTransform.html  All you really need to know is that it looks at a block of samples and returns information about the spectral content of that block."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 4.0, 299.0, 48.0 ],
