{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 21.0, 44.0, 1102.0, 766.0 ],
		"bglocked" : 0,
		"defrect" : [ 21.0, 44.0, 1102.0, 766.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 754.0, 100.0, 20.0 ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"numoutlets" : 1,
					"patching_rect" : [ 105.0, 705.0, 72.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"offset" : [ -4.0, -23.0 ],
					"patching_rect" : [ 60.0, 525.0, 134.0, 53.0 ],
					"outlettype" : [ "" ],
					"args" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-76",
					"numoutlets" : 1,
					"patching_rect" : [ 659.0, 651.0, 55.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-39",
					"numoutlets" : 1,
					"patching_rect" : [ 210.0, 465.0, 179.0, 68.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"numoutlets" : 1,
					"patching_rect" : [ 444.0, 720.0, 263.0, 31.0 ],
					"outlettype" : [ "" ],
					"fontname" : "Geneva"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-12",
					"numoutlets" : 1,
					"patching_rect" : [ 444.0, 621.0, 52.0, 52.0 ],
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-18",
					"numoutlets" : 2,
					"patching_rect" : [ 270.0, 375.0, 34.0, 20.0 ],
					"outlettype" : [ "bang", "" ],
					"fontname" : "Geneva"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-19",
					"numoutlets" : 1,
					"patching_rect" : [ 270.0, 404.0, 32.5, 18.0 ],
					"outlettype" : [ "" ],
					"fontname" : "Geneva"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-60",
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 684.0, 223.0, 39.0 ],
					"fontname" : "Geneva"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-61",
					"numoutlets" : 0,
					"patching_rect" : [ 495.0, 627.0, 86.0, 39.0 ],
					"fontname" : "Geneva"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-62",
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 579.0, 233.0, 39.0 ],
					"fontname" : "Geneva"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-39", 0 ],
					"hidden" : 0,
					"midpoints" : [ 43.5, 453.0, 219.5, 453.0 ]
				}
