{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 6.0, 44.0, 889.0, 667.0 ],
		"bglocked" : 0,
		"defrect" : [ 6.0, 44.0, 889.0, 667.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"patching_rect" : [ 24.0, 449.0, 100.0, 192.0 ],
					"numoutlets" : 2,
					"presentation" : 1,
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numinlets" : 2,
					"patching_rect" : [ 777.0, 59.0, 74.0, 56.0 ],
					"numoutlets" : 1,
					"id" : "obj-1",
					"fontname" : "Arial",
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 0,
					"patching_rect" : [ 233.0, 560.0, 211.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-9",
					"fontname" : "Arial",
					"patcher" : 					{
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"numinlets" : 1,
					"patching_rect" : [ 176.0, 476.0, 300.0, 39.0 ],
					"numoutlets" : 0,
					"id" : "obj-12",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 516.0, 318.0, 249.0, 48.0 ],
					"numoutlets" : 0,
					"id" : "obj-13",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 523.0, 366.0, 90.0, 54.0 ],
					"numoutlets" : 2,
					"setminmax" : [ -0.5, 0.5 ],
					"id" : "obj-16",
...
, 			{
				"box" : 				{
					...
					"candicane7" : [ 0.878431, 0.243137, 0.145098, 1.0 ],
					"patching_rect" : [ 612.0, 366.0, 87.0, 55.0 ],
					"numoutlets" : 2,
					"setminmax" : [ -0.5, 0.5 ],
					"id" : "obj-18",
					"candicane6" : [ 0.733333, 0.035294, 0.788235, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"numinlets" : 1,
					"patching_rect" : [ 176.0, 433.0, 379.0, 39.0 ],
					"numoutlets" : 0,
					"id" : "obj-20",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 652.0, 443.0, 162.0, 34.0 ],
					"numoutlets" : 0,
					"id" : "obj-21",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"numinlets" : 1,
					"patching_rect" : [ 596.0, 442.0, 54.0, 54.0 ],
					"numoutlets" : 1,
					"id" : "obj-22",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 238.0, 335.0, 155.0, 34.0 ],
					"numoutlets" : 0,
					"id" : "obj-25",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 0.329412, 0.098039, 1.0 ],
					"candicane7" : [ 0.878431, 0.243137, 0.145098, 1.0 ],
					"patching_rect" : [ 233.0, 366.0, 90.0, 54.0 ],
					"numoutlets" : 2,
					"setminmax" : [ -2.0, 2.0 ],
					"id" : "obj-32",
					"candicane6" : [ 0.733333, 0.035294, 0.788235, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 0.894118, 0.035294, 1.0 ],
					"candicane7" : [ 0.878431, 0.243137, 0.145098, 1.0 ],
					"patching_rect" : [ 322.0, 366.0, 87.0, 55.0 ],
					"numoutlets" : 2,
					"setminmax" : [ -2.0, 2.0 ],
					"id" : "obj-34",
					"candicane6" : [ 0.733333, 0.035294, 0.788235, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 597.0, 504.0, 232.0, 48.0 ],
					"numoutlets" : 2,
					"id" : "obj-61",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 0.894118, 0.035294, 1.0 ],
					"candicane7" : [ 0.878431, 0.243137, 0.145098, 1.0 ],
					"patching_rect" : [ 166.0, 583.0, 651.0, 57.0 ],
					"numoutlets" : 2,
					"id" : "obj-62",
					"candicane6" : [ 0.733333, 0.035294, 0.788235, 1.0 ],
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 164.0, 641.0, 613.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-64",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 25.0, 342.0, 183.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-82",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"numinlets" : 1,
					"patching_rect" : [ 177.0, 516.0, 379.0, 39.0 ],
					"numoutlets" : 0,
					"id" : "obj-83",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 1,
					"patching_rect" : [ 599.0, 556.0, 231.0, 17.0 ],
					"numoutlets" : 0,
					"id" : "obj-84",
					"fontname" : "Arial"
				}
