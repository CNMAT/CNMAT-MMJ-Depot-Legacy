	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"presentation_rect" : [ 14.0, 404.0, 0.0, 0.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"id" : "obj-16"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "stop",
					"numoutlets" : 1,
					"patching_rect" : [ 275.0, 533.0, 37.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "startwindow",
					"numoutlets" : 1,
					"patching_rect" : [ 185.0, 533.0, 84.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "dac~",
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 565.0, 37.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"fontname" : "Arial",
					"id" : "obj-12"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 565.0, 119.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"id" : "obj-13"
...
, 			{
				"box" : 				{
					...
					"text" : "400.",
					"numoutlets" : 1,
					"patching_rect" : [ 245.0, 242.0, 36.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "330.",
					"numoutlets" : 1,
					"patching_rect" : [ 211.0, 240.0, 36.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"bgcolor" : [ 1.0, 0.435294, 0.435294, 1.0 ],
					"numinlets" : 2,
