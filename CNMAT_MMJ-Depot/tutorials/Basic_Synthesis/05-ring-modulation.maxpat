{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 60.0, 44.0, 924.0, 651.0 ],
		"bglocked" : 0,
		"defrect" : [ 60.0, 44.0, 924.0, 651.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 615.0, 122.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 650.0, 208.0, 90.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 673.0, 285.0, 121.0, 86.0 ],
					"range" : [ -2.0, 2.0 ],
					"trigger" : 1,
					"triglevel" : 0.1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 272.0, 121.0, 86.0 ],
					"range" : [ -2.0, 2.0 ],
					"trigger" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 639.0, 247.0, 45.0, 20.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 178.0, 89.0, 20.0 ],
					"text" : "on_waveforms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.0, 252.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 447.0, 365.0, 133.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 222.0, 150.0, 20.0 ],
					"text" : "anti-aliasing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 221.0, 18.0, 18.0 ],
					"selection" : 1,
					"size" : 1,
					"values" : [ 1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 327.0, 193.0, 141.0, 23.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 75.0, 119.0, 786.0, 564.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 138.0, 242.0, 210.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 448.0, 146.0, 133.0 ],
					"range" : [ -2.0, 2.0 ],
					"trigger" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -5.0, -23.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 3.0, 524.0, 133.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 593.0, 37.0, 20.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 140.0, 432.0, 20.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 139.0, 379.0, 517.0, 20.0 ],
					"text" : "*~ 1."
				}
