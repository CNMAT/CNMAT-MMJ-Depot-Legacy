{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 44.0, 1168.0, 769.0 ],
		"bgcolor" : [ 0.443137, 0.439216, 0.439216, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 44.0, 1168.0, 769.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 148.0, 60.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 400.0, 128.0, 32.5, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-19"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 449.0, 126.0, 0.0, 0.0 ],
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "target $1, clear, target 0, play",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 469.0, 162.0, 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 228.0, 167.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-15"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 3,
					"presentation_rect" : [ 764.0, 192.0, 87.0, 50.0 ],
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 488.0, 356.0, 183.0, 24.0 ],
					"fontname" : "Arial",
					"presentation" : 1,
					"id" : "obj-154"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 3,
					"presentation_rect" : [ 772.0, 160.0, 200.0, 20.0 ],
					...
					"outlettype" : [ "int", "", "" ],
					"types" : [  ],
					"patching_rect" : [ 444.0, 396.0, 100.0, 20.0 ],
					"fontname" : "Arial",
					"presentation" : 1,
					"id" : "obj-144"
				}
...
, 			{
				"box" : 				{
					...
					"items" : [ "02-count.aif", ",", "08-count.aif" ],
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.0, 256.0, 81.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-70"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 276.0, 480.0, 56.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 5,
					"points" : [ 0.323864, 0.340278, "08-count.aif", 0.5625, 0.75, 0.1875, 0.0, 3.168365, 794347.9375, 0.1, 0.4278, 0, 0.690341, 0.628472, "02-count.aif", 0.75, 0.5625, 0.1875, 0.0, 2.897095, 302330.0, 0.1, 0.49017, 0, 0.5, 0.5, "null", 0.0, 0.0, 0.0, 1.0, 0.666667, 4.985344, 0.001, 1.0, 1 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 660.0, 188.0, 32.5, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-45"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 212.0, 54.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-30"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 3,
					"items" : [ "02-count.aif", ",", "06-count.aif", ",", "08-count.aif" ],
					"outlettype" : [ "int", "", "" ],
					"types" : [  ],
					"patching_rect" : [ 660.0, 164.0, 100.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-20"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-42", 0 ],
					"hidden" : 0,
					"midpoints" : [ 285.5, 525.0, 464.25, 525.0, 464.25, 418.0, 689.5, 418.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 625.5, 137.5, 453.5, 137.5 ]
				}
