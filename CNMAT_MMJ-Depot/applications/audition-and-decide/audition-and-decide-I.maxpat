{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 9.0, 45.0, 1271.0, 741.0 ],
		"bgcolor" : [ 0.819608, 0.87451, 0.858824, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 9.0, 45.0, 1271.0, 741.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print right",
					"patching_rect" : [ 800.0, 272.0, 52.0, 18.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print wrong",
					"patching_rect" : [ 928.0, 284.0, 60.0, 18.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sel aad1",
					"patching_rect" : [ 800.0, 248.0, 48.0, 18.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 800.0, 220.0, 101.0, 18.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r osc",
					"patching_rect" : [ 800.0, 188.0, 32.0, 18.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 0,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "- 1",
					"patching_rect" : [ 164.0, 588.0, 32.5, 18.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 212.0, 608.0, 20.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-28",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 224.0, 111.0, 18.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 260.0, 600.0, 195.0, 24.0 ],
					"presentation" : 1,
					"id" : "obj-58",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 492.0, 616.0, 248.0, 27.0 ],
					"presentation" : 1,
					"id" : "obj-11",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Arial",
