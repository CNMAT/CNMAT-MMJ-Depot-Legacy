	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"presentation_rect" : [ 569.0, 512.0, 0.0, 0.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 495.0, 612.0, 138.0, 20.0 ],
					"numoutlets" : 0,
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"ignoreclick" : 1,
					"name" : "badge.maxpat",
					"args" : [ "IS_OSC", "1.6b", "Zbyszynski and Campion", "Internal_Synth_OSC", 1000 ],
					"numinlets" : 0,
