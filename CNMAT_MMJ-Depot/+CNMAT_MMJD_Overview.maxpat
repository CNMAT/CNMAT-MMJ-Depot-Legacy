{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "March 2011-- this patch is seriously underdeveloped and only represents a limited portion of materials availabel in the Depot.",
					"linecount" : 2,
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
					"id" : "obj-1",
					"patching_rect" : [ 137.0, 38.0, 617.0, 34.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontsize" : 12.0,
					"presentation_rect" : [ 145.0, 47.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-28",
					"patching_rect" : [ 144.0, 9.0, 451.0, 34.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontsize" : 24.0
				}
