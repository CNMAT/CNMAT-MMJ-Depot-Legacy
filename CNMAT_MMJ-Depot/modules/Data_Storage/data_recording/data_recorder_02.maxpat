{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 217.0, 107.0, 1293.0, 845.0 ],
		"bglocked" : 0,
		"defrect" : [ 217.0, 107.0, 1293.0, 845.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"patching_rect" : [ 84.0, 52.0, 98.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-19",
					"outlettype" : [ "", "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 24.0, 184.0, 53.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-17",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 616.0, 172.0, 60.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-18",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 538.333313, 136.0, 35.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-7",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 464.333344, 136.0, 35.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-8",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 312.0, 156.0, 65.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-6",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 396.0, 148.0, 36.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-5",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 248.0, 156.0, 32.5, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-2",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "osc-route /rec /play /clear /stop /save /saveas /read /refer",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 9,
					"patching_rect" : [ 164.0, 96.0, 604.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-1",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 24.0, 240.0, 34.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-57",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 112.0, 548.0, 32.5, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-43",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 708.0, 176.0, 20.0, 20.0 ],
					"id" : "obj-38",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 464.0, 244.0, 145.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-34",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 341.5, 616.0, 44.5, 616.0, 44.5, 347.0, 105.5, 347.0 ]
				}
