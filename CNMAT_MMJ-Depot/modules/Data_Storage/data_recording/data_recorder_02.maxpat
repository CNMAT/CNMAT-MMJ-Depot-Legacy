...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 540.0, 196.0, 20.0, 20.0 ],
					"id" : "obj-38",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 540.0, 220.0, 60.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-18",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "osc-route /rec /play /clear /stop /save /saveas /read /refer /coll",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 10,
					"patching_rect" : [ 256.0, 84.0, 357.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-1",
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ]
				}
