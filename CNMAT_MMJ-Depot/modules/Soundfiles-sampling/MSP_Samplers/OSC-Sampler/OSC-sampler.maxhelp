{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 11.0, 78.0, 1028.0, 607.0 ],
		"bglocked" : 0,
		"defrect" : [ 11.0, 78.0, 1028.0, 607.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s oscsamp",
					"patching_rect" : [ 556.0, 508.0, 68.0, 20.0 ],
					"id" : "obj-85",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "audio output",
					"patching_rect" : [ 188.0, 120.0, 88.0, 20.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "spat",
					"patching_rect" : [ 960.0, 376.0, 35.0, 20.0 ],
					"textcolor" : [ 0.227451, 0.890196, 0.858824, 1.0 ],
					"id" : "obj-79",
					"fontname" : "Arial",
					"frgb" : [ 0.227451, 0.890196, 0.858824, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "making notes",
					"patching_rect" : [ 908.0, 120.0, 88.0, 20.0 ],
					"textcolor" : [ 0.227451, 0.890196, 0.858824, 1.0 ],
					"id" : "obj-75",
					"fontname" : "Arial",
					"frgb" : [ 0.227451, 0.890196, 0.858824, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "setup",
					"patching_rect" : [ 480.0, 120.0, 44.0, 20.0 ],
					"textcolor" : [ 0.227451, 0.890196, 0.858824, 1.0 ],
					"id" : "obj-74",
					"fontname" : "Arial",
					"frgb" : [ 0.227451, 0.890196, 0.858824, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"fontsize" : 12.0,
					"bgcolor" : [ 0.713726, 0.929412, 1.0, 1.0 ],
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 772.0, 444.0, 114.0, 19.0 ],
					"id" : "obj-51",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "stereo",
					"patching_rect" : [ 772.0, 416.0, 41.0, 19.0 ],
					"id" : "obj-50",
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "mono",
					"patching_rect" : [ 772.0, 388.0, 38.0, 19.0 ],
					"id" : "obj-49",
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 443.0, 166.0, 17.0 ],
					"id" : "obj-47",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 415.0, 154.0, 17.0 ],
					"id" : "obj-46",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 609.0, 387.0, 154.0, 17.0 ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 484.0, 287.0, 19.0 ],
					"id" : "obj-44",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 557.0, 383.0, 20.0, 20.0 ],
					"id" : "obj-41",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"size" : 16,
					"setminmax" : [ 0.0, 1.0 ],
					"patching_rect" : [ 532.0, 40.0, 201.0, 45.0 ],
					"id" : "obj-27",
					"ghostbar" : 28,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 52.0, 434.0, 19.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 11.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 460.5, 75.0, 475.0, 75.0, 475.0, 37.0, 541.5, 37.0 ]
				}
