{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 100.0, 122.0, 879.0, 588.0 ],
		"bglocked" : 0,
		"defrect" : [ 100.0, 122.0, 879.0, 588.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "sqrt 1.",
					"fontsize" : 12.0,
					"patching_rect" : [ 620.0, 204.0, 44.0, 20.0 ],
					"id" : "obj-34",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "t l b",
					"fontsize" : 12.0,
					"patching_rect" : [ 620.0, 116.0, 32.5, 20.0 ],
					"id" : "obj-23",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "thispoly~",
					"fontsize" : 12.0,
					"patching_rect" : [ 640.0, 144.0, 58.0, 20.0 ],
					"id" : "obj-20",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "zl nth",
					"fontsize" : 12.0,
					"patching_rect" : [ 620.0, 172.0, 39.0, 20.0 ],
					"id" : "obj-30",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "t b s",
					"fontsize" : 12.0,
					"patching_rect" : [ 28.0, 216.0, 33.0, 20.0 ],
					"id" : "obj-11",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "out~ 2",
					"fontsize" : 12.0,
					"patching_rect" : [ 328.0, 488.0, 44.0, 20.0 ],
					"id" : "obj-25",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "b 2",
					"fontsize" : 12.0,
					"patching_rect" : [ 100.0, 308.0, 32.5, 20.0 ],
					"id" : "obj-9",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "sfinfo~",
					"fontsize" : 12.0,
					"patching_rect" : [ 28.0, 348.0, 86.5, 20.0 ],
					"id" : "obj-6",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 6,
...
, 			{
				"box" : 				{
					...
					"text" : "out~ 1",
					"fontsize" : 12.0,
					"patching_rect" : [ 280.0, 488.0, 44.0, 20.0 ],
					"id" : "obj-24",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "in 2",
					"fontsize" : 12.0,
					"patching_rect" : [ 620.0, 88.0, 30.0, 20.0 ],
					"id" : "obj-19",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1,
