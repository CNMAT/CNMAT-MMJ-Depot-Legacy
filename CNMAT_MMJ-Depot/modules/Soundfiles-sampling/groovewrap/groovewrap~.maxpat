...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 760.0, 168.0, 35.0, 15.0 ],
					"presentation_rect" : [ 994.0, 31.0, 0.0, 0.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 183.5, 424.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.5, 453.0, 103.0, 18.0 ],
...
,
					"patching_rect" : [ 1135.428589, 164.0, 65.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"digest" : "",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.0, 837.166687, 106.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 236.0, 110.0, 17.0 ],
					"text" : "sample length"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 236.0, 308.0, 15.0 ],
					"text" : "0.997732 ms"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.0, 220.0, 140.0, 13.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 510.0, 65.0, 346.0, 109.0 ],
					"ruler" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.0, 797.166687, 106.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.000006, 216.0, 110.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 368.0, 184.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.0, 204.0, 140.0, 13.0 ],
					"tepidcolor" : [ 0.6, 0.729412, 0.0, 1.0 ],
					"warmcolor" : [ 0.85098, 0.85098, 0.0, 1.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 114.0, 135.0, 32.5, 17.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 114.0, 105.0, 164.0, 17.0 ],
									"text" : "expr 1./pow(pow(2.\\, 1./(12./100.))\\, $f1)"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 697.166687, 26.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 264.0, 136.0, 26.0, 15.0 ],
					"text" : "loop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.0, 196.0, 18.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 243.0, 136.0, 18.0, 18.0 ],
					"size" : 1,
					"values" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 617.166687, 46.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 116.0, 196.0, 46.0, 15.0 ],
					"text" : "loop end"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 777.166687, 54.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 196.0, 54.0, 15.0 ],
					"text" : "loop start"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 164.0, 196.0, 49.0, 16.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 737.166687, 54.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 172.0, 54.0, 15.0 ],
					"text" : "play from"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 657.166687, 60.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 152.0, 60.0, 15.0 ],
					"text" : "delay start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 597.0, 31.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 116.0, 132.0, 96.0, 16.0 ],
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 920.0, 717.166687, 126.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 132.0, 126.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 216.0, 80.0, 16.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 293.0, 178.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.0, 677.166687, 29.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 315.0, 182.0, 29.0, 17.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 196.0, 49.0, 16.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 152.0, 148.0, 16.0 ],
					"triscale" : 0.9,
					"varname" : "delaystart"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 243.0, 178.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 920.0, 817.166687, 29.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 265.0, 182.0, 29.0, 17.0 ],
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 356.0, 160.0, 131.0, 17.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 80.0, 252.0, 15.0 ],
					"text" : "/gain 1., /transposition 0., /delaystart 0., /playfrom 0., /loop 0."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 255.0, 75.0, 138.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 240.0, 64.0, 17.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 51.5, 285.0, 15.0, 15.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 12,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 356.0, 128.0, 798.428589, 17.0 ],
					"text" : "OSC-route /bufname /gain /transposition /delaystart /playfrom /play /dump /loop /loopstart /loopend /stop"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 118.0, 346.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 64.0, 172.0, 148.0, 16.0 ],
					"triscale" : 0.9,
					"varname" : "playfrom"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -9.0, -5.0, 444.0, 400.0 ],
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1190.928589, 189.429001, 1206.629517, 189.429001, 1206.629517, 74.209213, 489.5, 74.209213 ],
					"source" : [ "obj-119", 1 ]
				}
