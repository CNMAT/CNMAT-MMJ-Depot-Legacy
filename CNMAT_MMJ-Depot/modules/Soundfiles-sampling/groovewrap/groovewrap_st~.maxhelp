	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 184.0, 530.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 168.0, 559.0, 32.0, 77.0 ],
					"presentation_rect" : [ 170.0, 560.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 483.0, 187.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 238.0, 482.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 126.0, 83.0, 18.0 ],
					"text" : "/bufname sho"
				}
...
, 			{
				"box" : 				{
					"args" : [ "groovewrap_st~.help", "1.4b", "Campion & Zbyszynski", "groovewrap_st~", 2858 ],
					"id" : "obj-17",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "groovewrap_st~", "a playback wrapper for the groove~ object with memory and recall - now in living stereo" ],
					"id" : "obj-18",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 503.0, 95.0, 20.0 ],
					"text" : "s post-message",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 410.0, 125.0, 156.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 459.0, 122.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 178.833328, 525.0, 193.5, 525.0 ],
					"source" : [ "obj-69", 1 ]
				}
