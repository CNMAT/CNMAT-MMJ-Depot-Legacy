...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 170.0, 379.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "*playbuf~ accepts both mono and stereo files.  mono files are output both L and R channels",
					"linecount" : 4,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 252.0, 376.0, 144.0, 62.0 ],
					"id" : "obj-36",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontface" : 2,
					"fontsize" : 12.0,
					"presentation_rect" : [ 15.0, 111.0, 0.0, 0.0 ]
				}
