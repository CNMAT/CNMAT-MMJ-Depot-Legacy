...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 506.0, 168.0, 79.0, 130.0 ],
					"rounded" : 10.0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 487.0, 120.0, 98.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 479.0, 311.0, 112.0, 27.0 ],
					"text" : "miditester"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 213.0, 107.0, 29.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 365.0, 427.0, 32.5, 17.0 ],
					"text" : "!= 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 365.0, 455.0, 50.0, 17.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.0, 720.0, 79.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 554.0, 11.0, 32.0, 18.0 ],
					"text" : "input"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 485.0, 11.0, 57.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 247.0, 35.0, 219.0, 25.0 ],
					"tabs" : [ "1", "2", "3", "4", "5", "6", "7", "8" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1111.0, 648.0, 37.0, 18.0 ],
					"text" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 291.0, 186.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.207843, 0.458824, 0.419608, 0.0 ],
					"fontname" : "Arial",
					"fontsize" : 18.0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 274.0, 291.0, 44.0, 27.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 217.0, 291.0, 44.0, 27.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 565.0, 509.0, 32.722221, 29.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 421.0, 509.0, 32.722221, 29.0 ],
					"text" : "7"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 273.0, 509.0, 32.722221, 29.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 509.0, 32.722221, 29.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 565.0, 441.0, 32.722221, 29.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 421.0, 441.0, 32.722221, 29.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 273.0, 441.0, 32.722221, 29.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 129.0, 441.0, 32.722221, 29.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.862745, 0.956863, 0.035294, 0.0 ],
					"id" : "obj-42",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.2319, 0.2319, 0.2319, 1.0 ],
					"curvecolor" : [ 0.076327, 0.238833, 0.26549, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 251.0, 186.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 298.0, 57.0, 18.0 ],
					"text" : "<- channel"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 77.0, 62.0, 22.0 ],
					"text" : "set level"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 360.0, 81.0, 20.0 ],
					"text" : "SOUNDFILE",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 370.75, 243.0, 93.25, 47.0 ],
					"text" : "CURRENT\nACTIVE \nCHANNEL"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 380.0, 599.5, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 365.0, 514.0, 0.0, 0.0 ],
									"text" : "clear"
								}
...
,
					"patching_rect" : [ 194.5, 308.0, 65.5, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.5, 107.0, 41.0, 16.0 ],
					"text" : "cha $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 27.0, 107.0, 71.0, 20.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 651.0, 36.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 443.5, 355.0, 101.0, 24.0 ],
					"text" : "play soundfile"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 552.0, 355.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"peakcolor" : [ 0.976471, 0.007843, 0.007843, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 485.0, 35.0, 100.0, 61.0 ],
					"range" : [ 0.0, 0.01 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 79.0, 215.0, 43.0, 16.0 ],
					"text" : "max $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 215.0, 41.0, 16.0 ],
					"text" : "min $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 79.0, 235.0, 57.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 267.0, 109.5, 20.0 ],
					"text" : "pack 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 382.0, 355.0, 49.5, 25.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 487.0, 168.0, 18.0, 130.0 ],
					"rows" : 8
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 274.0, 251.0, 44.0, 27.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 217.0, 251.0, 44.0, 27.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 396.0, 427.0, 38.0, 17.0 ],
					"text" : "adc~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 174.5, 184.0, 106.0, 22.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 174.5, 209.0, 185.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 370.75, 293.5, 33.0, 27.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 184.0, 105.0, 22.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 209.0, 109.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 479.0, 3.0, 112.0, 301.0 ],
					"rounded" : 15
				}
