...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 40.0, 230.0, 32.5, 18.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 84.0, 230.0, 47.0, 18.0 ],
					"text" : "addpath"
				}
...
, 							{
						...
						"dependency_cache" : [ 							{
								...
								"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/applications/audition-and-decide/lib/collection_files",
								"type" : "TEXT",
								"implicit" : 1
							}
 ]
