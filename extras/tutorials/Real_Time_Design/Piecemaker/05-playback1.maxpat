{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "I've put the meters in a subpatch.",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ -1.0, 408.0, 96.0, 27.0 ],
					"id" : "obj-1",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "see the next tutorial for more explaination...",
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 401.0, 383.0, 318.0, 23.0 ],
					"id" : "obj-2",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					...
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 421.0, 184.0, 27.0 ],
					"id" : "obj-3",
					"fontsize" : 18.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "6) Click the spacebar. This is cue 4, which turns off the player module",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 334.0, 312.0, 39.0 ],
					"id" : "obj-4",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "5) Click the spacebar. This is cue 3, which plays \"thatfile.aif\".",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 296.0, 312.0, 39.0 ],
					"id" : "obj-5",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "4) Click the spacebar. This is cue 2, which plays \"thisfile.aif\".",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 259.0, 312.0, 39.0 ],
					"id" : "obj-6",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "3) Click the spacebar. This is cue 1, which is silent. It initializes the player.",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 221.0, 312.0, 39.0 ],
					"id" : "obj-7",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "2) Click the start message to turn on audio",
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 201.0, 312.0, 23.0 ],
					"id" : "obj-8",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "1) Click the init button",
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 181.0, 165.0, 23.0 ],
					"id" : "obj-9",
					"fontsize" : 14.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Here is an example that plays back specific soundfiles at each cue. To make it work:",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 155.0, 244.0, 27.0 ],
					"id" : "obj-10",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 562.0, 514.0, 174.0, 17.0 ],
					"id" : "obj-12",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 89.0, 332.0, 95.0, 17.0 ],
					"id" : "obj-20",
					"outlettype" : [ "", "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 89.0, 306.0, 36.0, 17.0 ],
					"id" : "obj-21",
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 2,
					"patching_rect" : [ 89.0, 360.0, 90.0, 17.0 ],
					"id" : "obj-22",
					"outlettype" : [ "signal", "signal" ],
					"fontsize" : 9.0,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 103.0, 44.0, 623.0, 472.0 ],
						"bglocked" : 0,
						"defrect" : [ 103.0, 44.0, 623.0, 472.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"mode" : 2,
									"patching_rect" : [ 60.0, 301.0, 39.0, 17.0 ],
									"id" : "obj-1",
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"numoutlets" : 2,
									"patching_rect" : [ 61.0, 140.0, 97.0, 17.0 ],
									"id" : "obj-2",
									"outlettype" : [ "", "" ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"numoutlets" : 2,
									"patching_rect" : [ 61.0, 252.0, 32.0, 17.0 ],
									"id" : "obj-4",
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"numoutlets" : 1,
									"patching_rect" : [ 228.0, 308.0, 35.0, 17.0 ],
									"id" : "obj-5",
									"outlettype" : [ "signal" ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"numoutlets" : 1,
									"patching_rect" : [ 148.0, 309.0, 35.0, 17.0 ],
									"id" : "obj-6",
									"outlettype" : [ "signal" ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "poly~ player1.voi",
									"numinlets" : 1,
									"fontname" : "Arial",
									"numoutlets" : 2,
									"patching_rect" : [ 148.0, 208.0, 90.0, 17.0 ],
									"id" : "obj-7",
									"outlettype" : [ "signal", "signal" ],
									"fontsize" : 9.0
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 228.0, 353.0, 15.0, 15.0 ],
									"id" : "obj-9",
									"comment" : "audio R"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-5", 1 ],
									"hidden" : 0,
									"midpoints" : [ 70.5, 284.0, 253.5, 284.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-6", 1 ],
									"hidden" : 0,
									"midpoints" : [ 70.5, 284.0, 173.5, 284.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 1,
					"patching_rect" : [ 89.0, 410.0, 76.0, 17.0 ],
					"id" : "obj-52",
					"outlettype" : [ "" ],
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "This is a feature that makes sure all effects are muted at initialization.",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 473.0, 174.0, 27.0 ],
					"id" : "obj-71",
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 129.0, 172.0, 27.0 ],
					"id" : "obj-72",
					"fontsize" : 18.0
				}
...
, 			{
				"box" : 				{
					...
					"shadow" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 121.0, 351.0, 293.0 ],
					"rounded" : 0,
					"id" : "obj-73",
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"background" : 1
