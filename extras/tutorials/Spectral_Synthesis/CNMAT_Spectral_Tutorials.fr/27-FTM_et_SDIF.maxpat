...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 597.0, 584.0, 96.0, 27.0 ],
					"text" : "voir aussi:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.0, 641.0, 64.0, 0.0 ],
					"text" : "prepend help"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 423.0, 151.0, 17.0 ],
					"text" : "comme vu précédemment..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 417.0, 262.0, 336.0, 17.0 ],
					"text" : "(Cet exemple est une adaptation tirée du wiki FTM de Diemo Schwarz's)"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "recombine les triplets en une seule grande liste"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "découpe la liste en triplets (index, fréquence, amplitude)"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Cliquer sur \"clear\"avant de charger un nouveau fichier SDIF file, sans quoi, vous en aurez deux à la fois"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 368.0, 314.0, 47.0 ],
					"text" : "Cliquer sur \"import\" pour charger un fichier SDIF dans un objet ftm comme matrice de nombres décimaux. ftm ne semble pas respecter l'idée des \"streams\" avec les fichiers SDIF, il serait donc prudent dans ce cas de n'utiliser les SDIF qu'avec un seul \"stream\"."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 604.0, 246.0, 145.0, 17.0 ],
					"text" : "<cliquer ici>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 417.0, 246.0, 199.0, 17.0 ],
					"text" : "Pour plus d'information à propos de FTM,"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.0, 233.0, 400.0, 17.0 ],
					"text" : "Voici un exemple rapide de l'utilisation des données SDIF avec une matrice FTM."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 536.0, 235.0, 224.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.0, 286.0, 350.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 415.0, 206.0, 164.0, 27.0 ],
					"text" : "SDIF avec FTM"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 419.0, 100.0, 17.0 ],
					"text" : "<- import SDIF"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 214.0, 161.0, 27.0 ],
					"text" : "Facteur de dilatation/compression temporelle (time stretch)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ -21.0, -22.0 ],
					"patching_rect" : [ 25.0, 20.0, 634.0, 101.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 33.0, 106.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 704.0, 47.0, 0.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 704.0, 61.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ -2.0, -39.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 663.0, 779.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 641.0, 83.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 200.0, 376.0, 79.0 ],
					"rounded" : 0,
					"shadow" : 2
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 439.5, 458.0, 391.5, 458.0 ],
					"source" : [ "obj-31", 0 ]
				}
