...
, 			{
				"box" : 				{
					"args" : [ "Rhythm as probability", "Use a probability table to play and generate rhythms", "0.38 0.612 0.612 0.7" ],
					"id" : "obj-64",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 581.0, 315.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 37.0, 352.0, 48.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.0, 173.0, 72.0, 17.0 ],
					"text" : "loadmess 100"
				}
...
,
					"patching_rect" : [ 382.0, 124.0, 137.0, 23.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"tags" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.0, 227.0, 67.0, 15.0 ],
					"text" : "startwindow"
				}
...
,
					"patching_rect" : [ 388.0, 180.0, 127.0, 23.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"tags" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 394.0, 234.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 62.0, 132.0, 204.0, 17.0 ],
					"text" : "OSC-route /voi1 /voi2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 160.0, 200.0, 52.0, 122.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 63.0, 200.0, 52.0, 122.0 ],
					"stripecolor" : [ 0.66667, 0.66667, 0.66667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 332.0, 107.0, 17.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 401.0, 312.0, 169.0, 48.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "migrate.maxpat",
				"bootpath" : "/Volumes/Rafael Valle/DESKTOP/Coding/CNMAT/CNMAT-MMJ-Depot/demos/migrator-demo",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
